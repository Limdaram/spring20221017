...
<br>
<button id="btn2">/ex40/sub02 get 방식 요청 option</button>
<br>
<button id="btn3">/ex40/sub03 post 방식 요청 option</button>
<br>
<hr>
<button id="btn4">/ex40/sub04 get 방식 요청 option</button>
<br>
<button id="btn5">/ex40/sub04 post 방식 요청 option</button>
<br>
<button id="btn6">/ex40/sub04 put 방식 요청 option</button>
<br>
<button id="btn7">/ex40/sub04  delete 방식 요청 option</button>
<br>
<hr>
<button id="btn8">/ex40/sub05  get 방식(R) 요청 option</button>
<br>
<button id="btn9">/ex40/sub05  post 방식(C) 요청 option</button>
<br>
<button id="btn10">/ex40/sub05  put 방식(U) 요청 option</button>
<br>
<button id="btn11">/ex40/sub05  delete 방식(D) 요청 option</button>
