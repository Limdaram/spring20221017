package com.example.spring20221017.controller.lecture.p06jdbc;
...
//				int b = 3 / a; // ArithmeticException;
    ...
    public void method3(String fname, String lname, int salary) throws Exception {
        // Employees 테이블 INSERT 쿼리 실행
        // Salary 테이블 INSERT 쿼리 실행

        // 위 두 쿼리가 모두 실행되거나 모두 실패할 수 있는 코드

        String sql1 = "INSERT INTO Employees (firstName, lastName) " +
                "VALUES (?, ?)";
        String sql2 = "INSERT INTO Salary (employeeId, salary) " +
                "VALUES (?, ?)";
